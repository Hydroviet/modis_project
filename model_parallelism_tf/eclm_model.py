...
from keras.layers import RNN, LSTMCell, Layer, InputSpec, BatchNormalization
...
class ConvRNN2D(RNN):
    ...
    def __call__(self, inputs, initial_state=None, constants=None, **kwargs):
        ...
        if initial_state is not None:
            print('initial_state is not None')
...
class Eclm2DCell(Layer):
    """Cell class for the Eclm2D layer.
    ...
    def __init__(self, filters,
                 ...
                 recurrent_dropout=0.,
                 **kwargs):
        super(Eclm2DCell, self).__init__(**kwargs)
    ...
    def get_config(self):
        ...
        base_config = super(Eclm2DCell, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))


class Eclm2D(ConvRNN2D):
    """Convolutional LSTM.
    ...
    def __init__(self, filters,
                 ...
                 recurrent_dropout=0.,
                 **kwargs):
        if n_out is None and not return_sequences:
            n_out = 1
        elif n_out == 1:
            return_sequences = False
        cell = Eclm2DCell(filters=filters,
        ...
        super(Eclm2D, self).__init__(cell,
                                     n_out,
    ...
    def __call__(self, inputs, initial_state=None, **kwargs):
      return super(Eclm2D, self).__call__(inputs,
    ...
    def call(self, inputs, mask=None, training=None, initial_state=None):
        print('Eclm2D call')
        outputs = super(Eclm2D, self).call(inputs,
                                           mask=mask,
                                           training=training,
                                           initial_state=initial_state)
        return outputs
    ...
    def get_config(self):
        config = {'filters': self.filters,
                  ...
                  'dropout': self.dropout,
                  'recurrent_dropout': self.recurrent_dropout}
        base_config = super(Eclm2D, self).get_config()
