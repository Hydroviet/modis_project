...
def input_fn(data_dir, subset, batch_size,
    ...
    dataset = dataset_utils.MTConvLSTMDataSet(data_dir, subset, use_distortion)
...
def main(gpu_id, data_dir, batch_size, use_distortion_for_training,
    ...
    hook = tf.contrib.estimator.stop_if_no_increase_hook(
        estimator, 'mse', 50000, min_steps=50000, run_every_secs=600)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_dir', default='result_patch/model')
    ...
    parser.add_argument('--starter_learning_rate', type=float, default=1e-3)
